...
Vector3d intersectrettaretta(const Vector3d& point, const Vector3d& dir, const Vector3d& point1, const Vector3d& dir1); //funzione che trova il punto di intersezione retta-segmento
}
